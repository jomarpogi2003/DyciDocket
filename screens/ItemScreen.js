      ...
      <ScrollView className="flex-1 px-4 py-6">
        <View className="relative bg-white shadow-lg">
          <Image
            ...
            className="w-full h-72 mt-8 rounded-2xl object-cover"
          />
          <View className="absolute flex-row inset-x-0 top-5 justify-between px-6">
            <TouchableOpacity
              onPress={() => navigation.navigate("Discover")}
              className="w-10 h-10 mt-6 rounded-md items-center justify-center bg-white"
            >
              <Entypo
            ...
            <TouchableOpacity className="w-10 h-10 mt-6 rounded-md items-center justify-center bg-white">
              <FontAwesome6 name="heart-pulse" size={24} color="" />
            </TouchableOpacity>
          </View>
          <View className="absolute flex-row inset-x-0 bottom-5 justify-between px-6">
            <View className="flex-row space-x-2 items-center">
              <Text className=" px-2 rounded-md text-[20px] font-bold text-gray-100 bg-blue-800">
                {data?.price_level}
              </Text>
              <Text className=" px-3  rounded-md text-[20px] font-bold text-gray-100 bg-slate-950">
                {data?.price}
              </Text>
            </View>
